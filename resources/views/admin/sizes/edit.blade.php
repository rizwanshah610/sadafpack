...
<div class="container-fluid">
    <div class="card">
        <div class="card-header">
            <h3 class="card-title"><i class="fas fa-edit mr-2"></i> Edit: {{ $size->name }}</h3>
        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="unit" class="form-control @error('unit') is-invalid @enderror">
                                ...
                                <option value="cm" {{ old('unit', $size->unit) == 'cm' ? 'selected' : '' }}>cm</option>
                                <option value="mm" {{ old('unit', $size->unit) == 'mm' ? 'selected' : '' }}>mm</option>
                                <option value="inch" {{ old('unit', $size->unit) == 'inch' ? 'selected' : '' }}>inch</option>
                                <option value="m" {{ old('unit', $size->unit) == 'm' ? 'selected' : '' }}>m</option>
                            </select>
