                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <span class="badge badge-info" id="productCount">Select a company to load products</span>
                        </div>
                    </div>
            ...
            products.forEach((product, index) => {
                ...
                const row = `
                    <tr>
                        ...
                        <td>
                            <div class="d-flex flex-wrap sizes-wrapper" style="opacity:0.4; pointer-events:none;">
                                ${sizesHtml}
                            </div>
                        </td>
                    </tr>
